...
import { Eye, EyeOff, Loader2, Lock, Mail, MessageSquare, MessageSquareText } from "lucide-react";
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2 pt-5">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="form-control">
                ...
                <div className="relative">
                  ...
                  <input
                    type="email"
                    className={`input input-boderded w-full pl-10`}
      ...
      <AuthImagePattern
        title="You belong here! Become a part of our vibrant community."
        subtitle="Join hands, share ideas, and make an impact!"
      />
    </div>
  );
};
